...
export default function ViewTicketModal({
  ...
  const generatePrintContent = () => {
    ...
    const resReqBy = reqBy
      ? `<div>Requested By</div><br><div>${reqBy}</div>`
      : "";
    ...
    const resappByStaff = appByStaff
      ? `${
          appByStaff +
          " " +
          showTicketData?.ApproveAccountingStaff?.UserDetails?.lname
        }`
      : "";
    ...
    const resappBySup = appBySup
      ? `${
          appBySup +
          " " +
          showTicketData?.ApproveAccountingHead?.UserDetails?.lname
        }`
      : "";
    ...
    const resEditedBy = editedBy
      ? `${
          editedBy +
          " " +
          showTicketData?.Automation?.UserDetails?.lname +
          " ON " +
          showTicketData?.TicketDetails?.date_completed
        }`
      : "";
  ...
  <style>
    ...
    @media print {
      ...
      <div class = "font-style">
        Requested by: ${reqBy}
        <br/>
        <div style="display: flex;">Approved by: ${values
          .map((value) => `${value}`)
          .join(" / ")}</div>
        Edited by: ${resEditedBy}
      </div>
    `;
    return content;
  };
                  ...
                  <div className="mt-3 flex w-full flex-row justify-between">
                    ...
                    (userRole === 4 &&
                      ...
                      <div className="ml-auto flex-col">
                        {loading ? (
                          <span className=" rounded-md bg-red-200 px-3 py-1 font-medium text-white">
                            Please Wait...
                          </span>
                        ) : (
                          <button
                        ...
                        {loadingApprove ? (
                          <span className=" rounded-md bg-green-200 px-3 py-1 font-medium text-white">
                            Please Wait...
                          </span>
                        ) : (
                          <button
                      ...
                      {userRole === 1 && (
                        <div>
                          ...
                          {showButton && (
                            <>
                              {loadingSave ? (
                                <span className="rounded-md bg-green-300 px-3 py-1 font-medium text-white">
                                  Please Wait...
                                </span>
                              ) : (
                                <button
                    ...
                    <div>
                      {(userRole === 1 || userRole === 2) && (
                        <>
                          ...
                          {loadingDone ? (
                            <span className=" rounded-md bg-blue-200 px-3 py-1 font-medium text-white">
                              Please Wait...
                            </span>
                          ) : (
                            <button
